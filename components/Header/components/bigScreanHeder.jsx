            ...
            <NavigationMenuList>
                <NavigationMenuItem>
                    <Link href="/O-mnie" legacyBehavior passHref>
                        <NavigationMenuLink
                            className={cn(
                                'text-white hover:text-accentColor mx-5'
                            )}
                        >
                            O Mnie
                        </NavigationMenuLink>
                ...
                <NavigationMenuItem>
                    ...
                    <NavigationMenuContent>
                        <ul className="grid gap-3  md:w-[400px] bg-prime lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
                                ...
                                <NavigationMenuLink>
                                    <div className="flex h-full w-full z-50 bg-calculator bg-cover  rounded-l-none  shadow-xl shadow-blue-300  p-2  rounded-xl select-none flex-col justify-strt  from-muted/50 to-muted  no-underline outline-none focus:shadow-md">
                                        <p className="text-xl leading-tight text-left  text-white text-muted-foreground textShadow">
                                            Zobacz dostępne kalkulatory i oblicz
                                            z łatwością swoje parametry
                                        </p>
                                    </div>
                                </NavigationMenuLink>
                            </li>
                            ...
                            >
                                Kalkulator Wagi Idealnej pomoże ci znaleść swoją
                                wymażoną wagę
                            </ListItem>
                            <ListItem
                            ...
                            >
                                Kalkulator BMI obliczy twoje BMI jak i pomoże ci
                                ja zinterpretować
                            </ListItem>
                            <ListItem
                            ...
                            >
                                Kalkulator Kalorii obliczy twoje zapotrzebowanie
                                kaloryczne jak i rospisze twoje makroelementy
                            </ListItem>
                        </ul>
                    </NavigationMenuContent>
                </NavigationMenuItem>
        ...
        <li>
            <NavigationMenuLink className=" hover:bg-prime     " asChild>
                <a
                    ...
                    {...props}
                >
                    <div className=" font-medium leading-none text-xl  text-white">
                        {title}
                    </div>
