    ...
    <div className="flex flex-row h-[90vh]   items-center  bg-hero bg-cover">
      ...
      <div className="relative  font-sans font-extrabold text-white w-1/2 h-[20vh]">
        ...
        >
          ...
          <p className="titleSize  textShadow pl-20  text-green-700">Wątroba</p></div>
          <p className="textShadow font-serif">Absolwent  AWF certyfikowany trener inne rzeczy do dodania potem  </p>
          <Link
          href={"/O-mnie"}><Button className="w-16 h-10">Więcej </Button></Link>
