                ...
                >
                    <div className="absolute bg-white w-1/3 max-sm:w-2/3 rounded-xl left-5 top-5 border-2 border-accentColor">
                        <h2 className="font-mono subtitleSize text-center font-bold">
                            {' '}
                            Wprowadzenie do Roli Treningu w Twojej Drodze do
                            Formy
                        </h2>

                        <p className="textSize p-3 font-serif">
                            Trening to niewątpliwie kluczowy element naszej
                            podróży ku zdrowiu i doskonałej formie fizycznej. To
                            właśnie przez regularne ćwiczenia, wzmacniamy nasze
                            mięśnie, poprawiamy wytrzymałość, spalamy tkankę
                            tłuszczową i zyskujemy ogólną siłę oraz kondycję.
                            Jeśli chcesz odmienić swoje ciało i zdrowie, nie
                            możesz pominąć znaczenia treningu.
                        </p>
                    </div>
                    <div className="absolute bg-white w-1/3 max-sm:w-2/3 rounded-xl left-1/3 top-[15rem] border-2 border-accentColor">
                        ...
                        <p className=" p-3 textSize font-serif">
                            Trening odgrywa kluczową rolę w naszym procesie
                            transformacji, ponieważ przyczynia się do budowy
                            mięśni, które nadają naszemu ciału kształt i
                            definicję. Ponadto, regularne ćwiczenia zwiększają
                            naszą wytrzymałość, poprawiają naszą postawę i
                            mobilność. Trening ma również pozytywny wpływ na
                            nasze zdrowie psychiczne, redukując stres i
                            poprawiając nastrój.
                        </p>
                    </div>
                    <div className="absolute bg-white w-1/3 max-sm:w-2/3 rounded-xl left-2/3 max-sm:left-0 top-[25rem] max-sm:top-[28rem] border-2 border-accentColor">
                        ...
                        <p className=" textSize p-3 font-serif">
                            Każdy z nas ma swoje własne cele fitness, dlatego
                            ważne jest, aby trening był spersonalizowany. Jako
                            Twój personalny trener, dostosuję plan treningowy do
                            Twoich potrzeb, umiejętności i ambicji. Razem
                            ustalimy, czy Twoim celem jest zwiększenie masy
                            mięśniowej, spalenie tłuszczu, poprawa wydolności
                            fizycznej czy ogólna poprawa zdrowia.
                        </p>
                    </div>
                </motion.div>
            </div>
