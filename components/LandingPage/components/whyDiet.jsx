...
export const WhyDiet = () => {
  ...
  return (
    ...
    className="  h-[150vh] absolute left-0 top-0 bg-red-50 w-full ">
      <img className="sticky top-0 h-screen  object-cover" src="/Bg_MyServicesDiet.jpg"/>
   
  </motion.div> 
  <div className="relative z-10  flex flex-col justify-end min-h-[100svh] ">

        <h1 className="text-white  textShadow font-sans text-5xl z-50 font-extrabold">Dieta</h1>
