    ...
    return (
        <>
            {name === 'Oferty' && object === null ? (
                <Dialog>
                    <DialogTrigger className="bg-black rounded-lg text-center flex justify-center items-center flex-row text-white text-lg p-2 font-bold">
                        Dodaj <Plus />
                    </DialogTrigger>
                    <DialogContent>
                        <DialogHeader>
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                <Input
                                                    placeholder="Oferta dla Mężczyzn"
                                                    {...field}
                                                />
                                            </FormControl>
                                            <FormMessage />
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormDescription>
                                                Cena wliczając przecene roczną :{' '}
                                                {form.getValues('price') -
                                                    (form.getValues('price') *
                                                        form.getValues(
                                                            'discountPerYear'
