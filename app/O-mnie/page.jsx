...
function Section({ children, style, reversSide, image }) {
    ...
    return (
        <div>
            <section
                className="flex relative z-30 h-[50vh] items-center  grainy"
                ref={ref}
            >
                ...
                <span
                    className={`bg-white h-2/3 w-1/F3 absolute ${
                        reversSide ? 'left-[55%]' : 'right-[55%] '
                    } border-b-8 border-blue-300  rounded-t-2xl p-2 ${style}`}
                    style={{
                        transform: isInView
                            ? 'none'
                            : reversSide
    ...
    return (
        <div>
            <div className="h-[80vh] bg-aboutMePicture bg-cover flex items-center justify-center">
                <h1 className=" text-white text-5xl font-semibold TextShadow">
                    Moja pasją jest Trenning
                </h1>
                <p></p>
            </div>
            <Section
            ...
            <Section image={'/person.svg'} reversSide={true}>
                Cos więcej o mnie
            </Section>
        </div>
    )
